$(document).ready(function () {
    ...
    var houses = {
        ...
        "Double sized Bedroom available in Albergaria-a-Velha": new House("Double sized Bedroom available in Albergaria-a-Velha",
            "This apartment has top quality features, we have a room available, it is very wide and it is double sized, there is also a private WC.",
            ["2", "1", "Private", "Included"],
            ["Rua Comendador Augusto Martins Pereira", "Albergaria-a-Velha", "Açores", "Açores", "3850-830", "43"],
            ["180.00", "11.00"],
            ["internet", "maquinaLavarLouca", "elevador"],
            ["https://en.nzpuretour.com/wp-content/uploads/2017/11/double-bed-and-single.jpg", "https://www.lanzet.co.uk/wp-content/uploads/2018/05/Lakeside-Blackburn.jpg", "http://www.csartcolorado.org/cdn_bl1/ni/graceful-nice-living-room-ideas-simple-country-french-home-design_room-interior-and-decoration.jpg"],
            [5,4], ["Adorei a minha estadia neste apartamento, tem condições do melhor e um senhorio que não desilude."],
            "locator2"),
        ...
        "Single sized Bedrooms in Porto": new House("Single sized Bedrooms in Porto",
            ...
            ["https://photos2.spareroom.co.uk/images/flatshare/listings/large/44/78/44787517.jpg", "https://i.ebayimg.com/images/g/GaMAAOSw4ZNctvEt/s-l800.jpg"],
            [3, 4], ["Gostei muito de cá viver, recomendo."],
            "locator3"),
        ...
        "Double Bedrooms in Sao Bernardo": new House("Double Bedrooms in Sao Bernardo",
            ...
            ["https://www.smithsgretnagreen.com/img/page/Deluxe%20Double%20Rooms_page_image.jpg","http://www.ramadawarwick.co.uk/wp-content/uploads/2014/10/standard-double.jpg","https://a0.muscache.com/im/pictures/809df5b0-5887-44de-9bd6-9d220b31c1fe.jpg?aki_policy=xx_large"],
            [4], ["Excelente casa, com ambiente muito bom, recomendo!"],
            "locator4"),

        "Single Sized Room Available in Lisboa": new House("Single Sized Room Available in Lisboa",
            "Nice small and cozy T0 Apartment with a bedroom available for anyone, it has an excelent location on Amadora.",
            ["1", "1", "Private", "Excluded"],
            ["Rua Elias Garcia", "Amadora", "Lisboa", "Lisboa", "3810-123", "51A"],
            ["250.00", "10.00"],
            ["aquecimento", "tvCabo"],
            ...
            [2], ["Gostei da minha estadia aqui, embora o preço seja um bocado elevado."],
            "locator5"),

        "Two Bedrooms available in Funchal": new House("Two Bedrooms available in Funchal",
            "Excelent two rooms renovated available for good people, it has a great location in Funchal.",
            ["2", "2", "Private", "Excluded"],
            ["Caminho da Água de Mel", "Funchal", "Madeira", "Madeira", "9050-050", "59"],
            ["145.00", "8.00"],
            ["internet"],
            ["https://a0.muscache.com/im/pictures/82172ddc-ba43-4483-b2d0-75d6ee6672a7.jpg?aki_policy=xx_large", "https://a0.muscache.com/im/pictures/beb29ecd-f6a9-4be4-bc13-ab895d7c4e2a.jpg?aki_policy=x_large", "https://www.shutterfly.com/ideas/wp-content/uploads/2017/08/simple-45.jpg"],
            [4], ["Quartos muito bons e espaçosos, sala de estar simples e elegante, gostei!"],
            "locator4"),
    };
